...
//            mProgressDialog.setProgress(values[0]);
    ...
    class FinishRecordingTask extends ProgressDialogTask<Void, Integer, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            if(restart){
                ...
                Log.d("dectection", "doInBackground: doAfterAllPermissionsGranted executed");
    ...
    class RecordingSwitch {
        ...
        public RecordingSwitch(RecordingSwitchListener recordingSwitchListener){
